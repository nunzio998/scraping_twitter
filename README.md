...
```bash
python Discord_scraping/discord_selenium_scraper.py
```
...
```bash
python Discord_scraping/discord_app_scraper.py
```
- drop_data_collection.py: script che cancella tutti i dati presenti nel database.
```bash
python Discord_scraping/drop_data_collection.py
```

### Scraping su Telegram
...
```bash
python Telegram_scraping/telegram_scraper.py
```
- drop_data_collection.py: script che cancella tutti i dati presenti nel database.
```bash
python Telegram_scraping/drop_data_collection.py
```

### Scraping su Twitter (X)
...
```bash
python X_scraping/chrome/tweet_scraper.py
```
```bash
python X_scraping/firefox/tweet_scraper.py
```
...
```bash
python X_scraping/chrome/user_info_scraper.py
```
```bash
python X_scraping/firefox/user_info_scraper.py
```
- related_user_finder.py: script che trova gli utenti correlati a quelli che ho già raccolto. 

```bash
python X_scraping/chrome/related_user_finder.py
```
```bash
python X_scraping/firefox/related_user_finder.py
```
- drop_data_collection.py: script che cancella tutti i dati presenti nel database.
```bash
python X_scraping/chrome/drop_data_collection.py
```
```bash
python X_scraping/firefox/drop_data_collection.py
```
- db_to_csv.py: script che esporta i dati dal database in un file csv.
```bash
python X_scraping/chrome/db_to_csv.py
```
```bash
python X_scraping/firefox/db_to_csv.py
```
